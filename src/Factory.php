 ...
 * @method static \FormManager\Fields\Hidden hidden(string $label, array $attributes)
 ...
 * @method static \FormManager\Fields\Select select(string $label, array $attributes)
