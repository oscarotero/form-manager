...
Validators\Datetime::$error_message = [
    'date' => 'Este valor non é unha data válida',
    'datetime' => 'Este valor non é unha data e hora válida',
    'datetimelocal' => 'Este valor non é unha data e hora local válida',
    'month' => 'Este valor non corresponde a un mes válido',
    'time' => 'Este valor non é unha hora válida',
    'week' => 'Este valor non corresponde a unha semana válida',
];
